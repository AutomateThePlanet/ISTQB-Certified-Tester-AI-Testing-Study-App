...
},
{
  ...
  "justification": {
    ...
    "c": "Is not correct. Scalability testing has not been mentioned as one of the \nrequirements. These are independent systems connected and are not \nconnected to any other systems",
    "d": "Is not correct. Fairness is using positively biased data for training. Since \nthere is no case of positive discrimination here, fairness testing is not \nrelevant \ne) Is correct. Data pipeline testing is required because the images can \ncome in various formats and resolutions. For the model to be trained all \nimages should have same format hence this testing is important"
  }
},
{
  "id": 29,
  "question": "An AI-based system is being used by the health ministry to identify vulnerable groups of patients, \nwho will be provided with support and advice to help prevent them suffering future illnesses to \nwhich they may be susceptible.  The results will also be shared with other government agencies \nand medical insurance companies.  The system is initially being trained on a large set of data \ncollected by the health ministry from two surveys of 5,000 men over 50 years of age and 25,000 \nwomen over 30 years of age.  The system will continue to identify vulnerable patients by gathering \ninformation from publicly available social media. \nWhich of the following attributes should be MOST carefully considered when specifying the \nobjectives and acceptance criteria for the system? Select TWO options.",
  "options": {
    "a": "Adaptability",
    "b": "Bias",
    "c": "Explainability",
...
},
{
  ...
  "justification": {
    ...
    "d": "Is not correct. While state transition testing might be useful, nothing in \nthe scenario suggests it; therefore, it is not the most relevant technique \ne) Is not correct. This testing is appropriate at the model testing stage for \nclassification problems. It is not appropriate at the system testing stage \nfor non-classification problems \n--------------------------"
  }
},
{
  "id": 51,
